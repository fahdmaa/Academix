...
export const StaggeredMenuNew = ({
  ...
  const menuButtonColor = theme === 'light' ? '#1A1A1A' : '#FFFFFF';
  const accentColor = theme === 'light' ? '#667eea' : '#8b5cf6';
...
export default StaggeredMenuNew;
